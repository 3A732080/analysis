...
def exec(question: str = 'None', action: str = 'None'):
    ...
    # text = "List the students who take the course taught by Frank?" 
    ...
    # text = "List the name of teachers who teach DBMS" 
    ...
    #text = "List the name of teachers who do not teach Advanced_DBMS" 
    ...
    # text = "List the name of teachers who do not teach all courses?" 
    ...
    # text = "List the name of course that are taught by Frank?" 
    ...
    # text = "List the courses that are not taught by Annie?" 
    ...
    # text = "List the courses that are taught by all teachers?"
    ...
    # text = "List the courses that are not taught by all teachers?" 
